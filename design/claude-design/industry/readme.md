<!-- SYNCED COPY — pulled 2026-08-22 from Claude Design project
     "Personal website redesign" (_ds/industry-b2d8b5d6). Do not hand-edit. -->
...
(The canvas project also carries `foundations/`, `components/`, `templates/`,
`theme.json` and demo pages; this mirror keeps only the stylesheet and this
guide — the implementable contract.)
