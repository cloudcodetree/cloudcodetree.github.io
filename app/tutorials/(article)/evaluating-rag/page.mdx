export const metadata = {
  title: 'RAG from Scratch: Evaluating Retrieval (Part 6 of 6) · Tutorials',
  description:
  ...
  openGraph: {
    title: 'RAG from Scratch: Evaluating Retrieval (Part 6 of 6)',
    ...
    type: 'article',
    images: [{ url: '/tutorials/covers/evaluating-rag.png', width: 1200, height: 675 }],
  },
  twitter: {
    card: 'summary_large_image',
    images: ['/tutorials/covers/evaluating-rag.png'],
  },
};

<TutorialHero slug="evaluating-rag" />
