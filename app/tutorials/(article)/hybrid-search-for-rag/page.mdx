export const metadata = {
  title: 'RAG from Scratch: Hybrid Search (Part 4 of 6) · Tutorials',
  description:
  ...
  openGraph: {
    title: 'RAG from Scratch: Hybrid Search (Part 4 of 6)',
    ...
    type: 'article',
    images: [{ url: '/tutorials/covers/hybrid-search-for-rag.png', width: 1200, height: 675 }],
  },
  twitter: {
    card: 'summary_large_image',
    images: ['/tutorials/covers/hybrid-search-for-rag.png'],
  },
};

<TutorialHero slug="hybrid-search-for-rag" />
