export const metadata = {
  title: 'RAG from Scratch: Reranking (Part 5 of 6) · Tutorials',
  description:
  ...
  openGraph: {
    title: 'RAG from Scratch: Reranking (Part 5 of 6)',
    ...
    type: 'article',
    images: [{ url: '/tutorials/covers/reranking-for-rag.png', width: 1200, height: 675 }],
  },
  twitter: {
    card: 'summary_large_image',
    images: ['/tutorials/covers/reranking-for-rag.png'],
  },
};

<TutorialHero slug="reranking-for-rag" />
