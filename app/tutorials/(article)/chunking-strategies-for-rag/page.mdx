export const metadata = {
  title: 'RAG from Scratch: Chunking Strategies (Part 3 of 6) · Tutorials',
  description:
  ...
  openGraph: {
    title: 'RAG from Scratch: Chunking Strategies (Part 3 of 6)',
    ...
    type: 'article',
    images: [{ url: '/tutorials/covers/chunking-strategies-for-rag.png', width: 1200, height: 675 }],
  },
  twitter: {
    card: 'summary_large_image',
    images: ['/tutorials/covers/chunking-strategies-for-rag.png'],
  },
};

<TutorialHero slug="chunking-strategies-for-rag" />
