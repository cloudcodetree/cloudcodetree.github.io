...
1. On the Mac, install the host from [remotedesktop.google.com/access](https://remotedesktop.google.com/access) (a small Chrome Remote Desktop Host), turn on **Remote Access**, and set a PIN.
2. From anywhere, open the same [remotedesktop.google.com/access](https://remotedesktop.google.com/access) in a browser signed into that Google account, click your Mac, and enter the PIN — no app install on the viewing side.
