export const metadata = {
  title: 'RAG from Scratch: Give Your RAG a Vector Database (Part 2 of 6) · Tutorials',
  description:
  ...
  openGraph: {
    title: 'RAG from Scratch: Give Your RAG a Vector Database (Part 2 of 6)',
    ...
    type: 'article',
    images: [{ url: '/tutorials/covers/vector-database-for-rag.png', width: 1200, height: 675 }],
  },
  twitter: {
    card: 'summary_large_image',
    images: ['/tutorials/covers/vector-database-for-rag.png'],
  },
};

<TutorialHero slug="vector-database-for-rag" />
